module.exports = function (grunt) {
  ...
  grunt.registerTask('build-windows', [
    'build',
    'exec:' + environment + '-windows'
  ]);
  grunt.registerTask('deploy', [
    ...
    'copy:main',
    'handlebars',
    'regex-replace:' + environment,
    'clean:dev',
    'uglify:main',
    'processhtml:' + environment]);

  grunt.registerTask('deploy-android', ['deploy', 'exec:' + environment + '-android']);
  grunt.registerTask('deploy-windows', ['deploy', 'exec:' + environment + '-windows']);
  grunt.registerTask('setup-android', ['copy:dev', 'exec:setup-android']);
  grunt.registerTask('setup-windows', ['copy:dev', 'exec:setup-windows']);
};
